...
class StreamlitApp:
    ...
    def run(self):
        ...
        if add_selectbox == 'Online':
            ...
            YearBuilt = st.number_input('Original construction date', min_value=1800.0, max_value=2021.0, value=1980.0)
            ...
            YearRemodAdd=st.number_input('Remodel date', min_value=1800.0, max_value=2021.0, value=1980.0)
